 ...
 */
final class Version20190731071012 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rci (id INT AUTO_INCREMENT NOT NULL, enseigne VARCHAR(255) NOT NULL, activite VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, email VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(5) NOT NULL, ville VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, telephone VARCHAR(10) NOT NULL, paiements LONGTEXT NOT NULL, horaires LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
